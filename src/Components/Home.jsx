    ...
    <div class="bg-slate-100 sm:h-screen  sm:flex justify-center items-center p-4 flex-row-reverse ">
      ...
      <div class="sm:w-3/5 sm:py-5 sm:pl-16 sm:pr-8">
        ...
        <div class="mt-7 flex justify-center sm:justify-start">
          <a class="inline-block rounded-md bg-purple-500 px-5 py-2 font-medium text-white" href="https://media.discordapp.net/attachments/937339895591079957/1006444456918126592/Olivia_Wilson.png?width=298&height=421" target="_blank">download Resume</a>
        </div>
      </div>
    </div>
